...
export default function InstallTabs() {
  const [tabs, setTabs] = useState([
    ...
    {
      name: 'no build',
      code: `<!-- Paste this into your HTML file -->\n<script src="https://cdn.jsdelivr.net/npm/hello-csv@0.3.8/dist/bundled/index.es.js"></script>\n<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/hello-csv@0.3.8/dist/bundled/hello-csv.css">`,
      current: true,
      terminal: false,
    },
  ]);
